...
export const SOURCE_CATALOG: ConnectorMeta[] = [
  ...
  // ── Lifestyle / feeds (registry-backed; connect via OAuth or token) ─
  {
    connector_id: 'strava',
    display_name: 'Strava',
    auth_type: 'oauth',
    ...
    icon: 'Activity',
    color: 'text-orange-400',
    description: 'Activities and workouts',
    unitLabel: 'activities',
    steps: [
      { label: 'Create a Strava API application and connect via OAuth (or use connector_manage from chat).' },
    ],
    inputFields: [],
  },
  {
    ...
    unitLabel: 'tracks',
    steps: [
      { label: 'Create a Spotify developer app and connect via OAuth (or use connector_manage from chat).' },
    ],
    inputFields: [],
  },
  {
    ...
    icon: 'Heart',
    color: 'text-rose-400',
    description: 'Sleep and readiness rings',
    unitLabel: 'days',
    steps: [{ label: 'Connect with your Oura personal access token from the Oura Cloud API.' }],
    inputFields: [
      { name: 'token', placeholder: 'Oura PAT', type: 'password' },
    ],
  },
  {
    ...
    icon: 'Cloud',
    color: 'text-sky-400',
    description: 'Local weather snapshots',
    unitLabel: 'reports',
    steps: [{ label: 'Configure location; OpenJarvis will poll a weather API on sync.' }],
    inputFields: [
      { name: 'path', placeholder: 'City or lat,lon', type: 'text' },
    ],
  },
  {
    ...
    steps: [{ label: 'Paste a GitHub personal access token with notifications scope.' }],
    inputFields: [
      { name: 'token', placeholder: 'ghp_...', type: 'password' },
    ],
  },
  {
    ...
    description: 'Top / new HN stories',
    unitLabel: 'stories',
    steps: [{ label: 'No credentials — connect and sync to index recent stories.' }],
    inputFields: [],
  },
  {
    ...
    icon: 'Rss',
    color: 'text-yellow-400',
    description: 'Arbitrary RSS / Atom feeds',
    unitLabel: 'articles',
    steps: [{ label: 'Paste one or more feed URLs (comma-separated) as the path.' }],
    inputFields: [
      { name: 'path', placeholder: 'https://example.com/feed.xml', type: 'text' },
    ],
  },
];
